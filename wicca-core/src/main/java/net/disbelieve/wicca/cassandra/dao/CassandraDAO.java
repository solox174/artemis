...
public abstract class CassandraDAO<T> {
    ...
    public BlockingQueue<Optional> getOne(BlockingQueue<Optional> queue, Object... primaryKey) {
        ...
        addCallBack(queue, resultFuture);
    ...
    protected void addCallBack(final BlockingQueue queue, ListenableFuture future) {
    ...
    protected BlockingQueue<Optional> mapResult(BlockingQueue<Optional> queue, Object obj) {
        try {
            Optional optional;
